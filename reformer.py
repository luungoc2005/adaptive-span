...
class ReformerLM(nn.Module):
    def __init__(self, 
        ...
        **kwargs
        ...
        super().__init__()
        emb_dim = default(emb_dim, hidden_size)
        self.token_emb = nn.Embedding(vocab_size, emb_dim)
        self.pos_emb = FixedPositionEmbedding(emb_dim) if fixed_position_emb else nn.Embedding(attn_span, emb_dim)
        self.to_model_dim = identity if emb_dim == hidden_size else nn.Linear(emb_dim, hidden_size)
    ...
    def forward(self, x, only_logits=False, **kwargs):
